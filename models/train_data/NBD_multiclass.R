...
best_nb_spec <- nb_fit_down %>% select_best(metric = "bal_accuracy")
...
# Matriz de confusión
table(final_nb_fit$.predictions[[1]]$.pred_class,
      final_nb_fit$.predictions[[1]]$heat)
...
# Guardar modelo
NB_multiclass <- final_nb_fit %>% extract_workflow()
# save(NB_multiclass, file = "models/NB_multiclass.RData")
