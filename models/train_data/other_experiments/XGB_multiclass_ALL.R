...
#   cv_folds,
#   metricas,
#   file = paste0("models/train_data/splits_multiclass", version, ".RData")
# )
...
so_split <- initial_split(data, strata = heat)
# Ahora ya puedes usar:
so_train <- training(so_split)
so_test <- testing(so_split)
cv_folds <- vfold_cv(so_train, strata = heat)
...
#   cv_folds,
#   metricas,
#   file = paste0("models/train_data/splits_binary", version, ".RData")
# )
